...
HD_PWD='E:/esperimenti/aspides/uart/uart.runs/ila_debug_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_debug.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_debug.tcl
