...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../uart.gen/sources_1/ip/clock_wizard" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.clock_wizard xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.clock_wizard -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log clock_wizard_sc.so .tmp_log xcelium_lib waves.shm c.obj)
