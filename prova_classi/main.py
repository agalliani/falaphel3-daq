...
# Importa FpgaConfigurator (assumendo sia nel file fpga_config.py)
...
class FpgaControlApp:
    def __init__(self, master):
        ...
        self.fpga_config = FpgaConfigurator()
        ...
        # Variabili per i nuovi input di configurazione
    ...
    def _send_spi_word(self, ser_int: SerialInterface, word_value: int):
        ...
        print(f"SPI 20-bit Data Write: 0x{word_value:05X}")
    ...
    def _send_injection_settings(self):
        ...
        try:
            # 1. Genera le parole di configurazione usando FpgaConfigurator
            word1, word2 = self.fpga_config.get_injection_settings(
    ...
    def _create_widgets(self):
        ...
        # Sezione 3: Injection Settings (Utilizzo di FpgaConfigurator)
        frame_inj = ttk.LabelFrame(self.master, text="Set Injection Section (FpgaConfigurator)")
        ...
        tk.Button(frame_inj, text="Generate and Inject", command=self._send_injection_settings).grid(row=4, column=0, columnspan=2, pady=10)
