    ...
    def send_configuration():
        ...
        try:
            ...
            if ALREADY_ACCESSED_SPI==False:
                ...
                write_command(ser, 0x30014,0xF)# 0x7)
...
##################################################
    ...
    tk.Button(root, text="Inject", command=send_configuration).grid(row=16, column=0, columnspan=2, pady=10)
    """
##################################################
