...
#
# Script generated by Vivado on Mon Apr 14 18:13:58 +0200 2025
...
# script info
echo -e "clock_wizard.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../uart.gen/sources_1/ip/clock_wizard" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.clock_wizard xil_defaultlib.glbl -o clock_wizard_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./clock_wizard_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key clock_wizard_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clock_wizard_simv.daidir vcs_lib c.obj)
