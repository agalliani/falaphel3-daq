...
#
# Script generated by Vivado on Tue Apr 15 16:36:14 +0200 2025
...
#
# Usage        : ila_debug.sh
#                ila_debug.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_debug.sh [-reset_run]
#                ila_debug.sh [-reset_log]
#                ila_debug.sh [-help]
#
...
#                script (type 'ila_debug.sh -help' for more information).
#
...
# script info
echo -e "ila_debug.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_debug.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../uart.gen/sources_1/ip/ila_debug/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_debug xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_debug -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_debug_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: ila_debug.sh [-step]\n\
Usage: ila_debug.sh [-lib_map_path]\n\
Usage: ila_debug.sh [-reset_run]\n\
Usage: ila_debug.sh [-reset_log]\n\
Usage: ila_debug.sh [-keep_index]\n\
