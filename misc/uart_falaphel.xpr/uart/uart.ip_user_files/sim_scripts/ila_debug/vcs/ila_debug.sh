...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../uart.gen/sources_1/ip/ila_debug/hdl/verilog" \
...
reset_run()
{
  files_to_remove=(ucli.key ila_debug_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_debug_simv.daidir vcs_lib c.obj)
