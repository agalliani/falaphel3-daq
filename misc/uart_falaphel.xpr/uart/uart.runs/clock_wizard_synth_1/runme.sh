...
HD_PWD='E:/esperimenti/ignite/projects/test board/firmware/uart/uart.runs/clock_wizard_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_wizard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_wizard.tcl
