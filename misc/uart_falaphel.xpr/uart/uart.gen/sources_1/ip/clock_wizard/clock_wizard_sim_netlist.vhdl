...
--               board/firmware/uart/uart.gen/sources_1/ip/clock_wizard/clock_wizard_sim_netlist.vhdl}
-- Design      : clock_wizard
...
entity clock_wizard_clk_wiz is
  port (
...
end clock_wizard_clk_wiz;

architecture STRUCTURE of clock_wizard_clk_wiz is
...
begin
inst: entity work.clock_wizard_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
